<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="MineArtiklerNY.aspx.cs" Inherits="Innsending1Admin.MineArtiklerNY" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section id="NyArtikkel">
        ...
        <table>
            ...
            <tr>
                <td>Bilde</td>
                <td><asp:FileUpload ID="BildeFileUpload" runat="server" />
                  </td>
            </tr>
        </table>
    ...
    <asp:Literal ID="OppdaterstatusLiteral" runat="server"></asp:Literal>
    </section>
    
    <section id="MineArtikler">
        <h1>Mine artikler</h1>
        <asp:Literal ID="MineArtiklerLiteral" runat="server"></asp:Literal>
    </section>
</asp:Content>
